...
export default function Home() {
  return (
    ...
    <div className="w-full max-w-md bg-white rounded-lg shadow-sm flex flex-col items-center p-6">
      <div className="mb-8">
      ...
      <h1 className="text-2xl font-bold text-center mb-4">Gets things with TODs</h1>
      
      <p className="text-gray-500 text-center mb-8 text-sm px-6">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris commodo quis libero eget vehicula.
      </p>

      <Link href="/register" className="w-full">
        <button className="w-full bg-[#0DD3C5] hover:bg-[#0bb0a3] text-white">
          Get Started
        </button>
      </Link>
    </div>
